...
<footer className="px-4 divide-y bg-black text-white hover:text-yellow-600">
  <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
    ...
    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
      ...
      <div className="space-y-3">
        <h3 className="uppercase dark:text-gray-900">Pricing</h3>
        <ul className="space-y-1">
        <li>
            <a rel="noopener noreferrer" href="/Pricing">
              details
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-start space-x-3">
          <a
            rel="noopener noreferrer"
            href="https://m.facebook.com/profile.php?id=100077572209404"
            title="Facebook"
          ...
          <a
            rel="noopener noreferrer"
            href="https://www.instagram.com/tasveer__fatema__official/"
            title="Instagram"
            className="flex items-center p-1"
          >
            <svg
